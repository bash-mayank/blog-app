  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Your Own <span className='text-primary'>Bloging</span> <br /> Plateform</h1>
        <p className="my-6 sm:my-8 max-w-2xl m-auto sm:text-xs text-gray-500"> 
