        ...
        <img src={data.image} alt="" className='rounded-3xl mb-5' />
         ...
         <div className='max-w-3xl mx-auto'>
            ...
            <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
              ...
              <textarea onChange={(e)=>setContent(e.target.value)} value={content} placeholder='Comment' required className="p-2 border border-gray-300 rounded outline-none h-48 w-full resize-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500" ></textarea>
         ...
         {/* Share Buttons */}
          <div className="my-24 max-w-3xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-4">
              {/* Facebook */}
              <button className="flex items-center gap-2 p-2 border rounded hover:bg-blue-600 hover:text-white transition">
                <img src={assets.facebook_icon} alt="Facebook" className="w-6 h-6" />
                <span>Facebook</span>
              </button>

              {/* Twitter */}
              <button className="flex items-center gap-2 p-2 border rounded hover:bg-blue-400 hover:text-white transition">
